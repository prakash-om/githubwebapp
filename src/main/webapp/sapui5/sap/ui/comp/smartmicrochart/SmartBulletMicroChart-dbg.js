...
sap.ui.define(['jquery.sap.global', 'sap/ui/comp/library', 'sap/ui/comp/providers/ChartProvider', 'sap/ui/core/Control', 'sap/suite/ui/microchart/library', 'sap/ui/core/CustomData', 'sap/m/ValueColor', 'sap/ui/comp/smartmicrochart/SmartMicroChartCommons'],
	...
	var SmartBulletMicroChart = Control.extend("sap.ui.comp.smartmicrochart.SmartBulletMicroChart", /** @lends sap.ui.comp.smartmicrochart.SmartBulletMicroChart.prototype */ {
		metadata : {
			...
			aggregations: {
				/**
				 * This private aggregation is used internally for binding of the DataPoint/CriticalityCalculation values used for calculation of the bar color
				 */
				...
				/**
				 * This private aggregation is used internally for binding of the sap.suite.ui.microchart.BulletMicroChart
				 */
				_chart : {
