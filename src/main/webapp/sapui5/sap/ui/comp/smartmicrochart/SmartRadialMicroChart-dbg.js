...
sap.ui.define(['jquery.sap.global', 'sap/ui/comp/library', 'sap/ui/core/Control', 'sap/suite/ui/microchart/library', 'sap/ui/core/CustomData', 'sap/ui/comp/smartmicrochart/SmartMicroChartCommons'],
	function(jQuery, library, Control, MicroChartLibrary, CustomData, SmartMicroChartCommons) {
	"use strict";
	...
	var SmartRadialMicroChart = Control.extend("sap.ui.comp.smartmicrochart.SmartRadialMicroChart", /** @lends sap.ui.comp.smartmicrochart.SmartRadialMicroChart.prototype */ {
		metadata : {
			...
			aggregations: {
				...
				/**
				 * This private aggregation is used internally for binding of the sap.suite.ui.microchart.RadialMicroChart
				 */
				_chart : {
